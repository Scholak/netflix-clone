			...
			<div className='mb-8 text-neutral-500 md:mb-16'>
				...
				<div className='flex items-center justify-center py-4 border-b border-neutral-600 md:justify-between'>
					...
					<div className='w-full flex items-center justify-between md:justify-end md:gap-28'>
						<span className={`w-full text-center font-bold md:w-20 ${planId === 0 && 'text-red'}`} onClick={() => setPlanId(0)}>
							99,99 TL
						</span>
						<span className={`w-full text-center font-bold md:w-20 ${planId === 1 && 'text-red'}`} onClick={() => setPlanId(1)}>
							149,99 TL
						</span>
						<span className={`w-full text-center font-bold md:w-20 ${planId === 2 && 'text-red'}`} onClick={() => setPlanId(2)}>
							199,99 TL
						</span>
					</div>
				</div>

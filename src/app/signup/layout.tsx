  ...
  return (
		<div>
			<nav className='flex items-center justify-between border-b border-neutral-300 py-3 px-4 sm:py-6 sm:px-10 md:px-20 lg:px-32'>
				...
				<Link href='/login' className='text-neutral-700 font-bold text-xl hover:underline'>
					Oturum Aç
				</Link>
			</nav>
			<main>{children}</main>
			<footer className='bg-neutral-50 text-neutral-700 border-t border-neutral-300 py-3 px-4 sm:py-6 sm:px-10 md:px-20 lg:px-32'>
				...
				<select className='py-2 px-4 bg-transparent outline-none border border-neutral-400 rounded-md cursor-pointer'>
					<option selected>
						Türkçe
					</option>
